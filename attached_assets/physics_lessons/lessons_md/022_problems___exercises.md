...
[Original URL](https://openstax.org/books/college-physics-2e/pages/2-problems-exercises)
...
![An x axis starts at 0 meters and ends at 12 meters. There are four points on the graph with position paths. Path A starts at 0 and stops at 7. Path B starts at 12 and ends at 7. Path C starts at 2, goes to 10, turns around and goes back to 8, then turns around again and stops at 10. Path D starts at 9, goes to 3, then turns around and stops at 5.](/apps/image-cdn/v1/f=webp/apps/archive/20260105.231123/resources/a745ec946fa6404a24a1b1c6b7058ca961ecdf74)

Figure 2.57

[1](chapter-2).

Find the following for path A in [Figure 2.57](2-problems-exercises#import-auto-id2076702): (a) The distance traveled. (b) The magnitude of the displacement from start to finish. (c) The displacement from start to finish.

2.

Find the following for path B in [Figure 2.57](2-problems-exercises#import-auto-id2076702): (a) The distance traveled. (b) The magnitude of the displacement from start to finish. (c) The displacement from start to finish.

[3](chapter-2).

Find the following for path C in [Figure 2.57](2-problems-exercises#import-auto-id2076702): (a) The distance traveled. (b) The magnitude of the displacement from start to finish. (c) The displacement from start to finish.

4.

Find the following for path D in [Figure 2.57](2-problems-exercises#import-auto-id2076702): (a) The distance traveled. (b) The magnitude of the displacement from start to finish. (c) The displacement from start to finish.
...
(a) By taking the slope of the curve in [Figure 2.58](2-problems-exercises#import-auto-id1798398), verify that the velocity of the jet car is 115 m/s at t\=20 st\=20 s. (b) By taking the slope of the curve at any point in [Figure 2.59](2-problems-exercises#import-auto-id4101417), verify that the jet car’s acceleration is 5.0 m/s25.0 m/s2.

![Line graph of position over time. Line has positive slope that increases over time.](/apps/image-cdn/v1/f=webp/apps/archive/20260105.231123/resources/2370f733c9e48a1259b180b9980399b99d407fb4)

Figure 2.58

![Line graph of velocity versus time. Line is straight with a positive slope.](/apps/image-cdn/v1/f=webp/apps/archive/20260105.231123/resources/313d14dc3b0eee46c6efc6244b035eea345f0f77)

Figure 2.59

60.

Using approximate values, calculate the slope of the curve in [Figure 2.60](2-problems-exercises#import-auto-id4122996) to verify that the velocity at t\=30.0 st\=30.0 s is approximately 0.24 m/s. Assume all values are known to 2 significant figures.

![Line graph of position versus time. Line is straight with a positive slope.](/apps/image-cdn/v1/f=webp/apps/archive/20260105.231123/resources/ecd0396d9c4f5aeee45a1a8c998f7a34b83a2769)

Figure 2.60

[61](chapter-2).

Using approximate values, calculate the slope of the curve in [Figure 2.60](2-problems-exercises#import-auto-id4122996) to verify that the velocity at t\=30.0 st\=30.0 s is approximately 0.24 m/s.

62.

By taking the slope of the curve in [Figure 2.61](2-problems-exercises#import-auto-id3552017), verify that the acceleration is 3.2 m/s23.2 m/s2 at t\=10 st\=10 s.

![Line graph of velocity versus time. Line has a positive slope that decreases over time until the line flattens out.](/apps/image-cdn/v1/f=webp/apps/archive/20260105.231123/resources/c77c952dd253632e42db4a969f7437601bbf3311)

Figure 2.61

[63](chapter-2).

Construct the position graph for the subway shuttle train as shown in [Figure 2.18](2-4-acceleration)(a). Your graph should show the position of the train, in kilometers, from t = 0 to 20 s. You will need to use the information on acceleration and velocity given in the examples for this figure.

64.

(a) Take the slope of the curve in [Figure 2.62](2-problems-exercises#import-auto-id4064858) to find the jogger’s velocity at t\=2.5 st\=2.5 s. (b) Repeat at 7.5 s. These values must be consistent with the graph in [Figure 2.63](2-problems-exercises#import-auto-id4128350).

![Line graph of position over time. Line begins sloping upward, then kinks back down, then kinks back upward again.](/apps/image-cdn/v1/f=webp/apps/archive/20260105.231123/resources/fb3dfbd8cc886ab895b49c78f7407485b4981199)

Figure 2.62

![Line graph of velocity over time. Line begins with a positive slope, then kinks downward with a negative slope, then kinks back upward again. It kinks back down again slightly, then back up again, and ends with a slightly less positive slope.](/apps/image-cdn/v1/f=webp/apps/archive/20260105.231123/resources/5b5e2fe7eda5c7303844d031832d4f3e70a6a084)

Figure 2.63

![Line graph of acceleration over time. Line begins with a negative slope, then curves upward with a positive slope, then kinks back upward again. It kinks back down again, then more gradually back up again, then curves back down again, and ends with a slightly negative slope.](/apps/image-cdn/v1/f=webp/apps/archive/20260105.231123/resources/dc844641ced9eb3751c0af515d290a511a784764)

Figure 2.64

[65](chapter-2).

A graph of vtvt is shown for a world-class track sprinter in a 100-m race. (See [Figure 2.65](2-problems-exercises#import-auto-id4125036)). (a) What is his average velocity for the first 4 s? (b) What is his instantaneous velocity at t\=5 st\=5 s? (c) What is his average acceleration between 0 and 4 s? (d) What is his time for the race?

![Line graph of velocity versus time. The line has two legs. The first has a constant positive slope. The second is flat, with a slope of 0.](/apps/image-cdn/v1/f=webp/apps/archive/20260105.231123/resources/6a4a6f03e9e2e970b8c37a9d4af418e11561089f)

Figure 2.65

66.

[Figure 2.66](2-problems-exercises#import-auto-id4035681) shows the position graph for a particle for 6 s. (a) Draw the corresponding Velocity vs. Time graph. (b) What is the acceleration between 0 s and 2 s? (c) What happens to the acceleration at exactly 2 s?

![Line graph of position versus time. The line has 4 legs. The first leg has a positive slope. The second leg has a negative slope. The third has a slope of 0. The fourth has a positive slope.](/apps/image-cdn/v1/f=webp/apps/archive/20260105.231123/resources/7832491d65942f151ab1e8405fb63f35114a3a9d)

Figure 2.66

[67](chapter-2).

Critical Thinking Two cars are side by side on a path where friction is negligible. Car A starts from rest and has a positive, constant acceleration while car B travels at a constant speed. The cars reach the same check point down the road at the same time. (a) Which car is traveling faster at the check point? Briefly explain your reasoning. (b) Based on experimental data, an equation that fits the data is suggested for the speed of car A at the check point, _V_, which may not be correct: V\=KV0V\=KV0, where _K_ is a constant with appropriate units and V0V0 is the initial velocity of car B. Is this equation consistent with your answer from part a? Explain why or why not. Does this equation make sense? Explain why or why not. (c) Graph the velocity of car A and the velocity of car B vs. distance along the path, starting when the cars are side by side.