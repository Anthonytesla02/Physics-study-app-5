...
[Original URL](https://openstax.org/books/college-physics-2e/pages/28-1-einsteins-postulates)
...
![A calculator is placed on open math books and few papers. Problems on trigonometry are solved on one of the papers.](/apps/image-cdn/v1/f=webp/apps/archive/20260105.231123/resources/edfb1757cc399f599e0ee5a360dce595659eb158)

Figure 28.3 Special relativity resembles trigonometry in that both are reliable because they are based on postulates that flow one from another in a logical way. (credit: Jon Oakley, Flickr)

Have you ever used the Pythagorean Theorem and gotten a wrong answer? Probably not, unless you made a mistake in either your algebra or your arithmetic. Each time you perform the same calculation, you know that the answer will be the same. Trigonometry is reliable because of the certainty that one part always flows from another in a logical way. Each part is based on a set of postulates, and you can always connect the parts by applying those postulates. Physics is the same way with the exception that _all_ parts must describe nature. If we are careful to choose the correct postulates, then our theory will follow and will be verified by experiment.
...
The speed of light is a constant c\=3.00×108m/sc\=3.00×108m/s _in a vacuum_. If you remember the effect of the index of refraction from [The Law of Refraction](25-3-the-law-of-refraction), the speed of light is lower in matter.
