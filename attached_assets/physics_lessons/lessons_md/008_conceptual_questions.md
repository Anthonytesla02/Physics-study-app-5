...
[Original URL](https://openstax.org/books/college-physics-2e/pages/1-conceptual-questions)
...
When is it _necessary_ to use relativistic quantum mechanics?
...
Prescriptions for vision correction are given in units called _diopters_ (D). Determine the meaning of that unit. Obtain information (perhaps by calling an optometrist or performing an internet search) on the minimum uncertainty with which corrections in diopters are determined and the accuracy with which corrective lenses can be produced. Discuss the sources of uncertainties in both the prescription and accuracy in the manufacture of lenses.